        ...
        <div>
            <div className=" flex flex-col items-center justify-center w-full mt-16">
                <div className=" w-80 mx-5 mb-16">
                    <h1 className=" text-4xl font-extrabold text-primaryColor">Fazer Login</h1>
                </div>

                <Link to="/login">
                    <div>
                        <div className=" w-[330px] h-[120px] border-2 border-primaryColor rounded-xl flex justify-around items-center px-2">
