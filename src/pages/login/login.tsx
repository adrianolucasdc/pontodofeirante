    ...
    return (
        <div className=" h-screen flex flex-col left ">
            ...
            <div className=" w-full h-full flex  items-center justify-center">
                <form action="" className=" flex flex-col items-center justify-center w-80 h-96 mx-6 px-5 rounded-xl border-2 border-primaryColor shadow-2xl">
                    ...
                    <div className=" flex flex-col items-center justify-around  h-full w-full mx-3">
                        <form action="" className=" h-52 flex flex-col justify-around">
